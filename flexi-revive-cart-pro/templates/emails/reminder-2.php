...
<title><?php echo isset( $email_subject ) ? esc_html( $email_subject ) : esc_html__( 'Your cart is waiting – act fast!', 'flexi-revive-cart-pro' ); ?></title>
</head>
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#fff3cd;padding:14px 32px;text-align:center;border-bottom:2px solid #ffc107;">
            <p style="margin:0;font-size:14px;font-weight:700;color:#856404;">⚠️ <?php esc_html_e( 'Items in your cart are selling fast – don\'t miss out!', 'flexi-revive-cart-pro' ); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:36px 32px 0;text-align:center;">
            <h2 style="font-size:22px;color:#1e1e1e;margin:0 0 8px;"><?php esc_html_e( 'Your cart is still waiting…', 'flexi-revive-cart-pro' ); ?></h2>
            <p style="font-size:15px;color:#555;margin:0;"><?php echo esc_html( sprintf( __( 'Hi %s,', 'flexi-revive-cart-pro' ), '{user_name}' ) ); ?></p>
            <p style="font-size:15px;color:#555;margin:12px 0 0;"><?php esc_html_e( 'Your cart was saved {abandoned_time}. These items are popular and inventory is limited.', 'flexi-revive-cart-pro' ); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:8px 32px 32px;text-align:center;">
            <a href="{recovery_link}" style="display:inline-block;background:#d63638;color:#ffffff;text-decoration:none;padding:16px 40px;border-radius:6px;font-size:16px;font-weight:700;">
              <?php esc_html_e( 'Secure My Cart Now', 'flexi-revive-cart-pro' ); ?>
            </a>
          </td>
        </tr>
