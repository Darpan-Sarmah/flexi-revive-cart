...
<title><?php echo isset( $email_subject ) ? esc_html( $email_subject ) : esc_html__( 'A special offer for you', 'flexi-revive-cart' ); ?></title>
</head>
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#edfbee;padding:20px 32px;text-align:center;">
            ...
            <p style="margin:6px 0 0;font-size:14px;color:#555;"><?php esc_html_e( 'Exclusive discount just for you – limited time offer!', 'flexi-revive-cart' ); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px 32px 0;text-align:center;">
            <h2 style="font-size:22px;color:#1e1e1e;margin:0 0 8px;"><?php esc_html_e( 'Last chance to complete your purchase!', 'flexi-revive-cart' ); ?></h2>
            <p style="font-size:15px;color:#555;margin:0;"><?php echo esc_html( sprintf( __( 'Hi %s, we saved a special discount just for you.', 'flexi-revive-cart' ), '{user_name}' ) ); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 32px 16px;text-align:center;">
            <table role="presentation" align="center" cellpadding="0" cellspacing="0" style="border:2px dashed #46b450;border-radius:8px;padding:14px 32px;">
              <tr>
                <td>
                  <p style="margin:0;font-size:12px;color:#555;text-transform:uppercase;letter-spacing:1px;"><?php esc_html_e( 'Use Code:', 'flexi-revive-cart' ); ?></p>
        ...
        <tr>
          <td style="padding:8px 32px 32px;text-align:center;">
            <a href="{recovery_link}" style="display:inline-block;background:#46b450;color:#ffffff;text-decoration:none;padding:16px 40px;border-radius:6px;font-size:16px;font-weight:700;">
              <?php esc_html_e( 'Claim My Discount', 'flexi-revive-cart' ); ?>
            </a>
            <p style="font-size:13px;color:#9ca3af;margin:16px 0 0;"><?php esc_html_e( 'Discount code expires in 72 hours.', 'flexi-revive-cart' ); ?></p>
          </td>
        </tr>
