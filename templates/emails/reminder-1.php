...
<title><?php echo isset( $email_subject ) ? esc_html( $email_subject ) : esc_html__( 'Your cart is waiting', 'flexi-revive-cart' ); ?></title>
</head>
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
        ...
        <!-- Header -->
        <tr>
          <td style="background:#7f54b3;padding:28px 32px;text-align:center;">
        ...
        <tr>
          <td style="padding:36px 32px 0;text-align:center;">
            ...
            <h2 style="font-size:22px;color:#1e1e1e;margin:16px 0 8px;"><?php esc_html_e( 'You left something behind!', 'flexi-revive-cart' ); ?></h2>
            <p style="font-size:15px;color:#555;margin:0;"><?php echo esc_html( sprintf( __( 'Hi %s,', 'flexi-revive-cart' ), '{user_name}' ) ); ?></p>
            <p style="font-size:15px;color:#555;margin:12px 0 0;"><?php esc_html_e( 'We noticed you left some items in your cart. Don\'t worry – we\'ve saved them for you.', 'flexi-revive-cart' ); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:8px 32px 32px;text-align:center;">
            <a href="{recovery_link}" style="display:inline-block;background:#7f54b3;color:#ffffff;text-decoration:none;padding:16px 40px;border-radius:6px;font-size:16px;font-weight:700;">
              <?php esc_html_e( 'Complete Your Purchase', 'flexi-revive-cart' ); ?>
            </a>
            <p style="font-size:13px;color:#9ca3af;margin:16px 0 0;"><?php esc_html_e( 'Your cart will be saved for 72 hours.', 'flexi-revive-cart' ); ?></p>
          </td>
        </tr>
